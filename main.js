...
const americano = new Producto(6, "Americano", 60, "img/americano.png");
const payLimon = new Producto(7, "Pay de Limon", 50, "img/payLimon.png");
const galletaChocolate = new Producto(8, "Galleta Chocolate" , 40, "img/galletaChocolate.png");



//Creamos un Array con todo nuestro catálogo de productos: 

const productos = [heladoLatte, caramelMacchiato, cappuccino, frappuccino, mocha, americano, payLimon, galletaChocolate];
...
const actualizarCarritoDOM = () => {
    ...
    // Iteramos sobre los productos en el carrito y creamos elementos HTML para cada uno
    carrito.forEach(producto => {
        ...
        `;
        // Agregamos el elemento al contenedor del carrito
        contenedorCarrito.appendChild(card);

        // Agregamos un event listener para el botón de eliminar producto
    ...
    // Calculamos y mostramos el total de la compra
    calcularTotal();
};
